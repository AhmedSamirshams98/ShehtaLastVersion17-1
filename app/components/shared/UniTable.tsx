...
//   isRowClickable?: (rowData: TData) => boolean;
// }
...
//                 <th
//                   key={header.id + index}
//                   className={`p-4 text-xs font-normal text-grey-400 text-right uppercase tracking-wider ${header.id === 'actions' || header.id === 'header-actions' ? '' : 'text-left'}`}
...
//             <tr
//               key={row.id}
//               className={`hover:bg-muted/50 data-[state=selected]:bg-muted/50 transition-all duration-150 ease-in-out ${
//                 onRowClick &&
...
//                 if (isRowClickable && !isRowClickable(row.original)) return;
...
//                   (typeof renderedCell === "string" && renderedCell.trim() === "") ||
//                   (Array.isArray(renderedCell) && renderedCell.length === 0);

//                 if (cell.column.id === "actions" || cell.column.id === "header-actions") {
//                   return (
//                     <td
//                       key={cell.id}
